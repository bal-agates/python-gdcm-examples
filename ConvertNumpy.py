...
if __name__ == "__main__":
    ...
    # For single-frame Monochrome shape is (rows, cols)
    # For single-frame RGB shape is (rows, cols, samplesPerPixel)
    # For multi-frame Monochrome shape is (frames, rows, cols)
    # For multi-frame RGB shape is (frames, rows, cols, samplesPerPixel)
