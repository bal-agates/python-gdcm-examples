...
if __name__ == "__main__":
    ...
    print("For single-frame Monochrome shape is (rows, cols)")
    print("For single-frame RGB shape is (rows, cols, samplesPerPixel)")
    print("For multi-frame Monochrome shape is (frames, rows, cols)")
    print("For multi-frame RGB shape is (frames, rows, cols, samplesPerPixel)")
